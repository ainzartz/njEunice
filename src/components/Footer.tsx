      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold tracking-widest uppercase">NJNY Realty</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted partner for premier real estate opportunities in New Jersey and New York.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link href="/about" className="hover:text-white transition-colors">About Eunice</Link></li>
              <li><Link href="/contact" className="hover:text-white transition-colors">Contact Us</Link></li>
              <li><Link href="/privacy-policy" className="hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link href="/cis" className="hover:text-white transition-colors">Consumer Info Statement</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 leading-relaxed mb-4">
              The data relating to real estate for sale on this web site comes in part from the Internet Data Exchange (IDX) program of the NJMLS. Real estate listings held by brokerage firms other than NJNY Realty are marked with the NJMLS logo and information about them includes the name of the listing brokers.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-xs text-gray-500">
          <p>&copy; {new Date().getFullYear()} Eunice. All rights reserved.</p>
