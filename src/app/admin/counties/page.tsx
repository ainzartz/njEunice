...
export default async function CountyManagementPage() {
      ...
      <div className="flex-grow pt-24 pb-12 px-6 sm:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-gray-200 pb-6">
            <div>
              <h1 className="text-3xl font-bold uppercase tracking-wider mb-2">Major County Management</h1>
              <p className="text-gray-500 uppercase tracking-widest text-sm font-semibold">
                Manage operational targets within New Jersey
              </p>
            </div>
            <a
              href="/admin"
